 ...
 * Arrays, lists and maps whose components obey the above rules are also supported
 * <p>
 * The unmarshalling of inner class dependecies has the following issue: If the top-level object is
 * an inner class instance, and any other outer class instance object has a reference to this inner
 ...
 * </pre>
 *
 * //then the marshalling will be as follows: //considering B as the top-level object
 * <p>
 *
 * <pre>
 * &lt;B [attributes]>
 ...
 * </p>
 * <p>
 * To avoid the stoppage of unmarshalling of the object tree when a node cannot be set on the
 * unmarshalled instance or when the node instance referred to does not exist in the currently
 * loaded java packages, the {@link #UNMARSHALL_ON_BINDING_EXCEPTION} can be set to true in order to
 * ignore this errors
 * </p>
 *
 * @author Marembo
...
public final class VMarshaller<T> implements java.io.Serializable {
  ...
  static {
    unmarshallOnBindingException = "true".equalsIgnoreCase(System
            .getProperty(UNMARSHALL_ON_BINDING_EXCEPTION, "true").trim());
    String defualtNamespace = System.getProperty(
            VNamespace.DEFUALT_NAMESPACE_PROPERTY_BINDING, "true");
    System.setProperty(VNamespace.DEFUALT_NAMESPACE_PROPERTY_BINDING,
            defualtNamespace);
  }
  ...
  public VElement marshall(T o) throws VXMLBindingException {
    ...
    if ((markup == null || markup.length() == 0)
      ...
      int ix1 = markup.lastIndexOf("."), ix2 = markup.lastIndexOf("$");
  ...
  public VElement marshall(T o, String markup) throws VXMLBindingException {
    try {
      ...
      ignoreGeneratedAttributes = getAnnotation(clazz,
              IgnoreGeneratedAttribute.class) != null;
      noNamespace = getAnnotation(clazz, NoNamespace.class) != null;
      System.out.println("NoNamespace: " + noNamespace);
      addAttribute(e, new VAttribute(
              VMarshallerConstants.CLASS_ATTRIBUTE, clazz.getName()));
      doMarshall(e, o);
      return e;
    } finally {
      idMapping.clear();
   ...
   */
  public T unmarshall(VDocument doc, VDocument documentSchema)
          throws VXMLBindingException {
    try {
      VElement elem = doc.getRootElement();
      this.marshallElement = elem;
  ...
  private T unmarshallArray(VElement elem) throws ClassNotFoundException,
          InstantiationException, IllegalAccessException,
          NoSuchMethodException, IllegalArgumentException,
          InvocationTargetException, VXMLBindingException {
    T o;
    // create the array
    String ct = elem.getAttribute(
            VMarshallerConstants.ARRAY_COMPONENT_CLASS_ATTRIBUTE)
            .getValue();
    String l = elem.getAttribute(
            VMarshallerConstants.ARRAY_LENGTH_ATTRIBUTE).getValue();
    Class cl = null;
    VAttribute va = elem
            .getAttribute(VMarshallerConstants.PRIMITIVE_ATTRIBUTE);
    if (va != null) {
      String p = va.getValue();
      if (p.equalsIgnoreCase("true")) {
        String wr = elem.getAttribute(
                VMarshallerConstants.PRIMITIVE_WRAPPER_ATTRIBUTE)
                .getValue();
        Object ob = Class.forName(wr)
  ...
  private T unmarshallPrimitive(VElement elem) throws ClassNotFoundException,
          InstantiationException, IllegalAccessException,
          NoSuchMethodException, IllegalArgumentException,
          InvocationTargetException {
    String wr = elem.getAttribute(
            VMarshallerConstants.PRIMITIVE_WRAPPER_ATTRIBUTE).getValue();
  ...
  private T unmarshallCollection(VElement elem, List<VElement> elems,
          Class clazz, VAttribute initAttr, T o) throws VXMLBindingException {
    List<VElement> elems_;
    VElement _el = null;
    // for compatibility purposes with the collections without elements
    // markup
    ...
    for (Iterator<VElement> it = elems_.iterator(); it.hasNext();) {
      ...
      VAttribute a = v
              .getAttribute(VMarshallerConstants.COLLECTION_EMPTY_MARKUP);
      if (a == null) {
        Object ob = unmarshallObject(v);
        ((Collection) o).add(ob);
      }
  ...
  private T unmarshallMap(VElement elem, List<VElement> elems, Class clazz,
          VAttribute initAttr, T o) throws VXMLBindingException {
    if (o == null) {
      ...
      if (EnumMap.class.isAssignableFrom(clazz)) {
        try {
          ...
          VElement key = entry.findChild(new VAttribute(
                  VMarshallerConstants.KEY_ATTRIBUTE, "true"));
          Class keyClass = Class.forName(key.getAttribute(
                  VMarshallerConstants.CLASS_ATTRIBUTE).getValue());
    ...
    for (ListIterator<VElement> it = elems.listIterator(); it.hasNext();) {
      ...
      VAttribute a = v
              .getAttribute(VMarshallerConstants.MAP_EMPTY_MARKUP);
      if (cv.size() == 2 && a == null) { // unmarshall only if not an
        // empty entry markup
        // which we know
        ...
        if (ke.getAttribute(VMarshallerConstants.KEY_ATTRIBUTE) != null) {
          key = unmarshallObject(ke);
                ...
                .getAttribute(VMarshallerConstants.VALUE_ATTRIBUTE) != null) {
  ...
  private T unmarshallBasic(VElement elem, VAttribute initAttr, Object o,
          Class clazz) throws VXMLBindingException {
    try {
      ...
      if (val == null) {
        ...
        if (o == null) {
          if (clazz.equals(String.class)) {
            ...
            Class spr = clazz;
            while (spr != Object.class && spr != Calendar.class
                    && spr != Date.class) {
            ...
            if (spr == Calendar.class) {
              ...
              // we consider if it can be an object with empty
              // elements
              o = newInstance(initAttr, clazz);
            }
          }
  ...
  private T unmarshallEnum(VElement elem, Class clazz)
          throws VXMLBindingException {
    String name;
    // for compatibility issues, we need to check if the instance has
    // enum_value specified
    ...
    if (em != null && elem.isParent(em.value())) {
      ...
      VAttribute va = elem
              .getAttribute(VMarshallerConstants.VALUE_ATTRIBUTE);
      if (va != null) {
        name = va.getValue();
      } else {
        name = elem.toContent();
  ...
  private T unmarshallBeanOrBasicObject(VElement elem, List<VElement> elems,
          VAttribute initAttr, Class clazz, Object o)
          throws VXMLBindingException {
    try {
      if (o == null) {
        ...
        if (clazz.equals(java.sql.Date.class)
          ...
          o = clazz.getConstructor(new Class[]{long.class})
                  .newInstance(new Object[]{0});
        } else if (clazz == MathContext.class) {
          // we need to unmarshall the properties and then instantiate
          // it as initializers attribute
          // we are sure there are only two properties because the
          // class is immutable and cannot be overidden
          if (elems.size() == 2) {
            ...
            for (VElement ve : elems) {
              if (ve.getAttribute(
                      VMarshallerConstants.CLASS_ATTRIBUTE)
                      .getValue().equals(Integer.class.getName())) {
                precisionEleme = ve;
              }
              if (ve.getAttribute(
                      VMarshallerConstants.CLASS_ATTRIBUTE)
                      .getValue()
                      .equals(RoundingMode.class.getName())) {
                roundingModeElem = ve;
              }
            }
  ...
  private T unmarshallSerializable(VElement elem) throws VXMLBindingException {
    ...
    try {
      // get the content
      // at this point we believe that the element has been determined to
      // be serialized
      VAttribute isAliased = elem
              .getAttribute(VMarshallerConstants.ALIAS_ATTRIBUTE);
      ...
      if (isAliased != null) {
        // get tha alias
        VAlias<T, Object> alias = (VAlias<T, Object>) Class.forName(
                isAliased.getValue()).newInstance();
      ...
      if (inn != null) {
        try {
          ...
          Logger.getLogger(VMarshaller.class.getName()).log(
  ...
  private T unmarshallOnConverter(VElement elem, VAttribute conAttr)
          throws VXMLBindingException {
    try {
      // we have a converter
  ...
  private T unmarshallOnAlias(VElement elem, Class clazz, VAttribute aliasAttr)
          throws VXMLBindingException {
    try {
      ...
      VAlias<T, Object> valias = (VAlias<T, Object>) aliasClass
              .newInstance();
  ...
  private T unmarshallOnReference(VElement elem, VAttribute _at__)
    ...
    if (tmp != null) {
      ...
      VElement el;
      try {
        el = elem.findChild(new VAttribute(
                VMarshallerConstants.OBJECT_REFERENCE_ID_ATTRIBUTE,
                val_));
      } catch (Exception e) {
        el = marshallElement.findChild(new VAttribute(
                VMarshallerConstants.OBJECT_REFERENCE_ID_ATTRIBUTE,
                val_));
      }
      if (el == null) {
        throw new VXMLBindingException(
                "Broken XML Document: Circular Reference Missing=" + id);
      }
      return (T) unmarshall(el);
    }
  }

  private void unmarshallOnInitialization(VElement elem, VAttribute initAttr,
          Object o) throws Exception {
    // get the elements specified and unmarshall them if they are not yet
    // marshalled
    ...
    for (String v : vals) {
      VElement vElem = elem.findChild(new VAttribute(
              VMarshallerConstants.OBJECT_REFERENCE_ID_ATTRIBUTE, v
              .trim()));
      params.add(vElem);
    }
  ...
  private T unmarshallOnInnerClass(VElement elem, VAttribute at_,
          VAttribute initAttr) throws ClassNotFoundException,
          VXMLBindingException {
    Class cl = Class.forName(elem.getAttribute(
            VMarshallerConstants.CLASS_ATTRIBUTE).getValue());
    // lets determine if the outer class is already instantiated
    VAttribute _at_ = elem
            .getAttribute(VMarshallerConstants.OUTER_CLASS_REFERENCE_ATTRIBUTE);
    if (_at_ == null) {
      throw new VXMLBindingException(
    ...
    if (ref == null) {
      ...
      VElement el = elem
              .findChild(VMarshallerConstants.OUTER_CLASS_REFERENCE_ELEMENT_MARKUP);
      if (el == null) {
  ...
  private T unmarshallObject(VElement elem, Class clazz)
          throws VXMLBindingException {
    try {
      // first things first, are we serialized?
      VAttribute serialAttr = elem
              .getAttribute(VMarshallerConstants.SERIALIZED_ATTRIBUTE);
      if (serialAttr != null
              && "true".equalsIgnoreCase(serialAttr.getValue())) {
        return unmarshallSerializable(elem);
      }
      Object o = null;
      List<VElement> elems = elem.getInstanceChildren();
      // check if we are referencing another object
      VAttribute _at__ = elem
              .getAttribute(VMarshallerConstants.OBJECT_CIRCULAR_REFERENCE_ATTRIBUTE);
      if (_at__ != null) {
        return unmarshallOnReference(elem, _at__);
      }
      // are we working with converters and aliases
      VAttribute conAttr = elem
              .getAttribute(VMarshallerConstants.CONVERTER_ATTRIBUTE);
      VAttribute aliasAttr = elem
              .getAttribute(VMarshallerConstants.ALIAS_ATTRIBUTE);
      if (conAttr != null) {
      ...
      VAttribute initAttr = elem
              .getAttribute(VMarshallerConstants.INITIALIZERS_ATTRIBUTE);
      if (initAttr != null) {
        unmarshallOnInitialization(elem, initAttr, o);
      }
      // we need to unmarshall an inner class over here
      VAttribute at_ = elem
              .getAttribute(VMarshallerConstants.INNER_CLASS_ATTRIBUTE);
      if (at_ != null) {
        o = unmarshallOnInnerClass(elem, at_, initAttr);
      }
      // check if it is an array
      VAttribute a = elem
              .getAttribute(VMarshallerConstants.ARRAY_ATTRIBUTE);
      ...
      VAttribute aa = elem
              .getAttribute(VMarshallerConstants.COLLECTION_ATTRIBUTE);
      if (aa != null && aa.getValue().contains("true")) {
        ...
        if (aa != null && aa.getValue().trim().equalsIgnoreCase("true")) {
          ...
          // if the mapcontains no other properties apart from the map
          // members
          // then return
          if (elems.isEmpty()) {
            return (T) o;
      ...
      if (elems.isEmpty() && o == null) {
        // then we have either primitive wrapper or a string or simply
        // an object without values
        VAttribute converter = elem
                .getAttribute(VMarshallerConstants.CONVERTER_ATTRIBUTE);
        if (converter != null) {
        ...
        return unmarshallBeanOrBasicObject(elem, elems, initAttr,
                clazz, o);
      }
    } catch (Exception e) {
      if (e instanceof VXMLBindingException) {
  ...
  private T unmarshallObject(VElement elem) throws VXMLBindingException {
    try {
      VAttribute a = elem
              .getAttribute(VMarshallerConstants.CLASS_ATTRIBUTE);
      Class clazz = null;
      if (a != null) {
        String val = a.getValue();
        VAttribute primAttr = elem
                .getAttribute(VMarshallerConstants.PRIMITIVE_ATTRIBUTE);
        // we must not be working with primitives
        if (primAttr != null
                && "true".equalsIgnoreCase(primAttr.getValue().trim())) {
  ...
  private T newInstance(VAttribute initAttr, Class clazz)
          throws VXMLBindingException {
    return newInstance(initAttr, clazz, null);
  }

  private T newInstance(VAttribute initAttr, Class<?> clazz, Object zeroOrder)
          throws VXMLBindingException {
    try {
      Class[] paramCls;
      Object[] params;
      ...
      if (ff != null) {
        ...
        for (Method m : clazz.getDeclaredMethods()) {
          ...
          if (Modifier.isStatic(mod)
                  && m.getAnnotation(Factory.class) != null) {
      ...
      for (Constructor c : cons) {
        ...
        if (paramTypes.length == paramCls.length) {
          ...
          for (int j = 0; j < paramTypes.length; j++) {
            ...
            if (!paramClass.equals(expectedClass)
                    && !paramClass.isAssignableFrom(expectedClass)) {
              // it may be a primitive
              if (isWrapperType(expectedClass)) {
                // then check if it is a wrapper for this class
                Class prim = PRIMITIVE_WARPPER_MAPPING
                        .get(expectedClass);
                if (prim != paramClass) {
                  continue SEARCH;
                }
  ...
  private void unmarshallProperties(List<VElement> elems, Class clazz,
          Object o) throws VXMLBindingException {
    try {
      ...
      for (VElement v : elems) {
        ...
        if (namespace != null
                && namespace.equals(VNamespace.XINCLUDE_NAMESPACE)) {
          continue;
        }
        // did it contain a markup annotation
        VAttribute prop = v
                .getAttribute(VMarshallerConstants.OBJECT_PROPERTY_ATTRIBUTE);
        String s = v.getMarkup();
        if (prop != null) {
          s = prop.getValue();
        } else {
          // did we define an escape sequence
          VAttribute escapeSequence = v
                  .getAttribute(VElement.ESCAPE_SEQUENCE);
        ...
        if (v.hasAttribute(VMarshallerConstants.CLASS_ATTRIBUTE)) {
          Class cl = Class.forName(v.getAttribute(
                  VMarshallerConstants.CLASS_ATTRIBUTE).getValue());
          String props = s.substring(0, 1).toUpperCase() + s.substring(1);
          s = "set" + props;
          // lets find the equivalent getter method. it may specify
          ...
          try {
            ...
            if (gM != null) {
              Informational info = gM
                      .getAnnotation(Informational.class);
              Marshallable ms = gM.getAnnotation(Marshallable.class);
              if (info == null
                      && (ms == null || (ms.marshal() && ms.write()))
                      && v.getAttribute(VMarshallerConstants.INFORMATIONAL_ATTRIBUTE) == null) {
                mm = getMethod(clazz, s, cl);
                if (mm == null) {
                  // try primitives
                  if (cl.equals(Integer.class)) {
                    mm = clazz.getDeclaredMethod(s,
                            new Class[]{int.class});
          ...
          VAttribute nullAttr = v
                  .getAttribute(VMarshallerConstants.NULL_PROPERTY);
          Object ob = null;
          // is the property null
          // technically, even the property of this object that were
          // marshalled for informational purposes will be
          // ignored
          // we check the false status since it may have been changed by
          // adding
          // the property values and thus liable for instantiation
          if (nullAttr == null
                  || "false".equalsIgnoreCase(nullAttr.getValue())) {
            ob = unmarshallObject(v);
          }
          if (mm != null) {
            // we do this at this point after we are sure we have
            // managed to fully understand the property
            mm.setAccessible(true);
  ...
  private Method getMethod(Class clazz, String name, Class param) {
    ...
    try {
      ...
      // then lets iterate
      List<Class> superCz = new ArrayList<Class>(Arrays.asList(param
              .getInterfaces()));
  ...
  private void doMarshall(VElement elem, T o) throws VXMLBindingException {
    ...
    if (!noNamespace) {
      Namespaces namespaces = o.getClass()
              .getAnnotation(Namespaces.class);
      if (namespaces != null && namespaces.namespaces().length > 0) {
        ...
        for (Namespace namespace : namespaces.namespaces()) {
          vNamespace[i++] = new VNamespace(namespace.prefix(),
                  namespace.uri(), namespace.elementFormDefault(),
                  namespace.attributeFormDefault(),
                  namespace.includeFormDefaultAttributeOnFalse());
        }
      }
      Namespace namespace = o.getClass().getAnnotation(Namespace.class);
      if (namespace != null) {
        vNamespace = ArrayUtil
                .copyOf(vNamespace, vNamespace.length + 1);
        vNamespace[vNamespace.length - 1] = new VNamespace(
                namespace.prefix(), namespace.uri(),
                namespace.elementFormDefault(),
                namespace.attributeFormDefault(),
                namespace.includeFormDefaultAttributeOnFalse());
      } else if (vNamespace.length == 0) {
        // did we define the default namespace
        // Leave the property for compatibility issues
        String defValue = System.getProperty(
                VNamespace.DEFUALT_NAMESPACE_PROPERTY_BINDING, "false");
        if (defValue.trim().equalsIgnoreCase("true")) {
          vNamespace = new VNamespace[]{VNamespace.VJAX_NAMESPACE};
        }
      }
    }
    doMarshall(elem, o, vNamespace, null, null, null, null, false, false,
            null);

  }

  private void doMarshallArray(VElement elem, T o, Class clazz,
          VNamespace namespace[], String elementMarkup)
          throws VXMLBindingException {
    if (elementMarkup == null || elementMarkup.length() == 0) {
      elementMarkup = VMarshallerConstants.ELEMENT_ELEMENT_MARKUP;
    }
    addAttribute(elem, new VAttribute(VMarshallerConstants.ARRAY_ATTRIBUTE,
            "true"));
    addAttribute(elem, new VAttribute(
            VMarshallerConstants.ARRAY_LENGTH_ATTRIBUTE, Array.getLength(o)
            + ""));
    addAttribute(elem, new VAttribute(
            VMarshallerConstants.ARRAY_COMPONENT_CLASS_ATTRIBUTE, clazz
    ...
    if (clazz.getComponentType().isPrimitive()) {
      ...
      addAttribute(elem, new VAttribute(
              VMarshallerConstants.PRIMITIVE_WRAPPER_ATTRIBUTE, Array
              .get(o, 0).getClass().getName()));
      int len = Array.getLength(o);
      for (int i = 0; i < len; i++) {
        Object ob = Array.get(o, i);
        VElement vb = new VElement(elementMarkup);
        addAttribute(vb, new VAttribute(
                VMarshallerConstants.CLASS_ATTRIBUTE, clazz
                .getComponentType().getName()));
        addAttribute(vb, new VAttribute(
                VMarshallerConstants.PRIMITIVE_ATTRIBUTE, clazz
                .getComponentType().isPrimitive() + ""));
        addAttribute(vb, new VAttribute(
                ...
                .get(o, 0).getClass().getName()));
        elem.addChild(vb);
        doMarshall(vb, (T) ob, namespace, null, null, null, null,
                false, false, null);
      }
    } else {
      Object[] ob = (Object[]) o;
      for (Object b : ob) {
        if (b != null) {
          ...
          addAttribute(vb, new VAttribute(
                  VMarshallerConstants.CLASS_ATTRIBUTE, b.getClass()
                  .getName()));
          elem.addChild(vb);
          doMarshall(vb, (T) b, namespace, null, null, null, null,
                  false, false, null);
        }
      }
    }
  ...
  private void doMarshallSerializable(VElement elem, T o)
          throws VXMLBindingException {
  ...
  private T checkAlias(VElement elem, Class<?> clazz, Method m, T o)
          throws Exception {
    // check if we are aliased
    Alias alias = clazz != null ? clazz.getAnnotation(Alias.class) : m
            .getAnnotation(Alias.class);
    if (alias != null) {
      Class aliasClass = alias.alias();
      if (!VAlias.class.isAssignableFrom(aliasClass)) {
        throw new VXMLBindingException(
                "Invalid Alias assignment on class: " + aliasClass);
      }
      VAlias<T, Object> valias = (VAlias<T, Object>) aliasClass
              .newInstance();
      ...
      clazz = o.getClass();
      // add alias data
      elem.addAttribute(new VAttribute(
              VMarshallerConstants.ALIAS_ATTRIBUTE, clazz.getName()));
      elem.addAttribute(new VAttribute(
              VMarshallerConstants.ALIAS_CLASS_ATTRIBUTE, aliasClass
              .getName()));
    }
   ...
   * @throws Exception
   */
  private boolean checkConverter(VElement elem, Class<?> clazz, Method m, T o)
          throws Exception {
    // check if we have a converter
    Converter con = clazz != null ? clazz.getAnnotation(Converter.class)
            : m.getAnnotation(Converter.class);
    if (con != null) {
      Class conClass = con.converter();
      if (!VConverter.class.isAssignableFrom(conClass)) {
        throw new VXMLBindingException(
                "Invalid Converter assignment on class: " + conClass);
      }
      VConverter vcon = (VConverter) conClass.newInstance();
      if (!vcon.isConvertCapable(o.getClass())) {
        throw new VXMLBindingException(
                "Invalid Converter Specified for class type: "
                + o.getClass());
      }
      // add the converter
      addAttribute(elem,
  ...
  private VMarkupGenerator<T> checkDynamicMarkup(VElement elem,
          Class<?> clazz, T o) throws Exception {
  ...
  private boolean checkSerializable(VElement elem, Class<?> clazz, Method m,
          T o) throws Exception {
    // at this point, we need to check if we are working with binary data
    Serialized bin = (Serialized) (clazz != null ? clazz
            .getAnnotation(Serialized.class) : m
            .getAnnotation(Serialized.class));
    if (bin != null) {
      addAttribute(elem, new VAttribute(
              VMarshallerConstants.SERIALIZED_ATTRIBUTE, "true"));
  ...
  private boolean checkCircularReference(VElement elem, Class<?> clazz, T o)
    ...
    if (idMapping.containsKey(refid) && !isInner && !(o instanceof String)
            && !o.getClass().isEnum()) {
      addAttribute(elem, new VAttribute(
              VMarshallerConstants.OBJECT_CIRCULAR_REFERENCE_ATTRIBUTE,
              refid + ""));
      return true;
    } else {
      // add the id
  ...
  private boolean checkInner(VElement elem, Class<?> clazz, T o,
          VNamespace[] namespace, String elementParam1) throws Exception {
    ...
    if (isInner) {
      ...
      try {
        ...
        if (refObj == null) {
          // decode it
          VElement _this = new VElement(
                  VMarshallerConstants.OUTER_CLASS_REFERENCE_ELEMENT_MARKUP,
                  elem);
          addAttribute(_this, new VAttribute(
                  VMarshallerConstants.CLASS_ATTRIBUTE, ref
                  .getClass().getName()));
          doMarshall(_this, (T) ref, namespace, elementParam1, null,
                  null, null, false, false, null);
        }
        addAttribute(elem, new VAttribute(
                VMarshallerConstants.OUTER_CLASS_REFERENCE_ATTRIBUTE,
                id + ""));
        addAttribute(elem, new VAttribute(
                VMarshallerConstants.INNER_CLASS_ATTRIBUTE, "true"));
      } catch (Exception ex) {
        throw new VXMLBindingException(ex);
      }
    }
  ...
  private boolean checkEnum(VElement elem, Class<?> clazz, T o,
          VNamespace[] namespace, VMarkupGenerator<T> generator)
          throws Exception {
    addAttribute(elem, new VAttribute(VMarshallerConstants.ENUM_ATTRIBUTE,
            clazz.isEnum() + ""));
    ...
    String enumMarkup = (em != null) ? em.value()
            : VMarshallerConstants.ENUM_VALUE_ELEMENT;
    VElement en = new VElement(enumMarkup, elem);
    // Enum values are constants by default
    addAttribute(en, new VAttribute(
            VMarshallerConstants.CONSTANT_ATTRIBUTE, "true"));
  ...
  private boolean checkCollection(VElement elem, T o, VNamespace[] namespace,
          ...
          boolean onCollectionOrMapEmpty, boolean wrapCollectionElements,
          Annotation[] annotations) throws Exception {
    Collection c = (Collection) o;
    addAttribute(elem, new VAttribute(
            VMarshallerConstants.COLLECTION_ATTRIBUTE, "true"));
    VElement _elem_;
    // reassign the element here if we are not to wrap elements in the
    // COLLECTION_ELEMENT_MARKUP
    if (!wrapCollectionElements) {
      _elem_ = elem;
    } else {
      _elem_ = new VElement(
              VMarshallerConstants.COLLECTION_ELEMENT_MARKUP, elem);
    }
    if (c.isEmpty()) {
      if (onCollectionOrMapEmpty) {
        ...
        addAttribute(fe, new VAttribute(
                VMarshallerConstants.COLLECTION_EMPTY_MARKUP,
                elementParam2));
        _elem_.addChild(fe);
        marshallNullProperties(fe, namespace, elementClass1, null);
        addAttribute(fe, new VAttribute(
                VMarshallerConstants.CLASS_ATTRIBUTE, elementParam2));
      }
    } else {
      // check if we are supposed to ignore collections here, and add the
      ...
      if (ac != null && !ac.value()) {
        ...
        // At this point, the collection element had been added to the
        // parent.
        // Remove it
      ...
      for (Object o1 : c) {
        ...
        _elem_.addChild(fe);
        addAttribute(fe, new VAttribute(
                VMarshallerConstants.CLASS_ATTRIBUTE, o1.getClass()
                .getName()));
        doMarshall(fe, (T) o1, namespace, null, null, null, null,
                false, false, null);
      }
    }
    return true;
  ...
  private boolean checkMap(VElement elem, T o, VNamespace namespace[],
          String elementParam1, String elementParam2, Class<?> elementClass1,
          Class<?> elementClass2, boolean onCollectionOrMapEmpty,
          boolean wrapCollectionElements, Annotation[] annotations)
          throws Exception {
    // is it a map
    Map m = (Map) o;
    // then we need to save this as map-entry pairs
    addAttribute(elem, new VAttribute(VMarshallerConstants.MAP_ATTRIBUTE,
            "true"));
    if (m.isEmpty()) {
      if (onCollectionOrMapEmpty) {
        VElement ee = new VElement(
                VMarshallerConstants.MAP_ENTRY_ELEMENT_MARKUP, elem);
        VElement kElem = new VElement(
                (elementParam1 != null && elementParam2 != null) ? elementParam1
                : VMarshallerConstants.KEY_ATTRIBUTE);
        VElement vElem = new VElement(
                (elementParam1 != null && elementParam2 != null) ? elementParam2
                : VMarshallerConstants.VALUE_ATTRIBUTE);
        // elementClass1 for key class
        addAttribute(ee, new VAttribute(
                VMarshallerConstants.MAP_EMPTY_MARKUP, elementParam2));
      ...
      if (attrs != null) {
        ...
        elem = parent;
        VConverter keyConverter = (VConverter) (attrs.keyConverter() != VConverter.class ? attrs
                .keyConverter().newInstance() : null);
        VConverter valueConverter = (VConverter) (attrs
                .valueConverter() != VConverter.class ? attrs
                .valueConverter().newInstance() : null);
        for (Object k : m.keySet()) {
          Object v = m.get(k);
          if (v != null) {
            String atName = keyConverter != null ? keyConverter
                    .convert(k) : k.toString();
            String atValue = valueConverter != null ? valueConverter
        ...
        for (Object k : m.keySet()) {
          Object v = m.get(k);
          VElement ee = new VElement(
                  VMarshallerConstants.MAP_ENTRY_ELEMENT_MARKUP);
          VElement kElem = new VElement(
                  (elementParam1 != null && elementParam2 != null) ? elementParam1
                  : VMarshallerConstants.KEY_ATTRIBUTE);
          addAttribute(kElem, new VAttribute(
                  VMarshallerConstants.CLASS_ATTRIBUTE, k.getClass()
                  .getName()));
          addAttribute(kElem, new VAttribute(
                  VMarshallerConstants.KEY_ATTRIBUTE, "true"));
          VElement vElem = new VElement(
          ...
          addAttribute(vElem, new VAttribute(
                  VMarshallerConstants.CLASS_ATTRIBUTE, v.getClass()
                  .getName()));
          addAttribute(vElem, new VAttribute(
          ...
          ee.addChild(vElem);
          elem.addChild(ee);
          doMarshall(kElem, (T) k, namespace, null, null, null, null,
                  false, false, null);
          doMarshall(vElem, (T) v, namespace, null, null, null, null,
                  false, false, null);
        }
      }
    }
  ...
  private void doMarshall(VElement elem, T o, VNamespace namespace[],
          String elementParam1, String elementParam2, Class<?> elementClass1,
          Class<?> elementClass2, boolean onCollectionOrMapEmpty,
          boolean wrapCollectionElements, Annotation[] annotations)
          throws VXMLBindingException {
    ...
    if (_ns != null) {
      ...
      namespace = new VNamespace[]{new VNamespace(_ns.prefix(),
        _ns.uri())};
    }
    ...
    try {
      ...
      if (clazz.isPrimitive()) {
        ...
        elem.addAttribute(new VAttribute(
                VMarshallerConstants.CONVERTER_ATTRIBUTE,
                VCalendarConverter.class.getName()));
        ...
        elem.addAttribute(new VAttribute(
                VMarshallerConstants.CONVERTER_ATTRIBUTE,
                VDateConverter.class.getName()));
      } else if (clazz.isArray()) {
        doMarshallArray(elem, o, clazz, namespace, elementParam1);
      } else {
        if (Collection.class.isAssignableFrom(o.getClass())) {
          // determine if we are working with generic collections
          checkCollection(elem, o, namespace, elementParam1,
                  elementParam2, elementClass1,
                  onCollectionOrMapEmpty, wrapCollectionElements,
                  annotations);
        } else if (Map.class.isAssignableFrom(o.getClass())) {
          if (checkMap(elem, o, namespace, elementParam1,
                  elementParam2, elementClass1, elementClass2,
                  onCollectionOrMapEmpty, wrapCollectionElements,
                  annotations)) {
            return;
          }
   ...
   * @return
   */
  private <T extends Annotation> T getAnnotation(Class<?> clazz,
  ...
  private <T extends Annotation> T getInterfaceAnnotation(Class<?> clazz,
          Class<T> annotationClass) {
    T t = null;
    ...
    for (Class<?> cl : cls) {
      ...
      if (t != null) {
        ...
        if (t != null) {
          Inherited i = t.annotationType().getAnnotation(
                  Inherited.class);
          return i != null ? t : null;
        }
      }
  ...
  private <T extends Annotation> T getAnnotation(Method m,
    ...
    if (t == null) {
      ...
      // make sure that the annotation is inherited, otherwise forget
      // about it.
      if (t != null) {
        Inherited i = t.annotationType().getAnnotation(Inherited.class);
        if (i == null) {
   ...
   * @return
   */
  private static boolean normalizeMethod(Method m, ListIterator<Method> it,
          Class clazz) {
    ...
    if (((!mName.startsWith("is") || mName.length() < 3) && (!mName
            .startsWith("get") || mName.length() < 4))
    ...
    // the properties must have a setter and getter methods, unless it is
    // marked as marshallable
    if (ms == null) {
      // it must be marked as marshallable if it does not have
      ...
      // since we may have synthetic methods we may be carefull not to
      // remove
      try {
        ...
        try {
          ...
          Method sM = clazz.getMethod(setName,
   ...
   * @param clazz
   */
  private static void normalizeMethods(List<Method> mms, boolean setter,
          Class clazz) {
    if (!setter) {
  ...
  private String getName(Method f) {
    ...
    int i1 = -1, i2 = -1;
    if (name != null
            && ((i1 = name.indexOf("get")) == 0 || (i2 = name.indexOf("is")) == 0)
            && name.length() > 3 && f.getParameterTypes().length == 0) {
      String mName;
      if (i1 == 0) {
  ...
  private boolean checkXmlMarkup(Method m, VElement elem, T o)
          throws Exception {
    // could the value of this property be specified as the markup of the
    // parent
    ...
    if (markup != null) {
      ...
      if (!cls.isPrimitive() && !isWrapperType(cls)
        ...
        if (con == null) {
          throw new VXMLBindingException(
                  "XmlMarkup Specification is invalid. The following XmlMarkup class is not accepted:"
                  + cls.getName());
        }
        VConverter vcon = (VConverter) con.converter().newInstance();
        if (!vcon.isConvertCapable(cls)) {
          throw new VXMLBindingException(
                  "XmlMarkup Specification is invalid. The following XmlMarkup class: "
                  + ""
                  + cls.getName()
      ...
      if (value == null) {
        throw new VXMLBindingException("Error on XmlMarkup Binding: "
                + cls.getName());
      }
   ...
   * @throws Exception
   */
  private boolean marshallAttribute(VElement elem, T o, Method m)
          throws Exception {
    // add it as attribute
    // this can be an Id or an attribute element without being annotated as
    // Attribute
    Class cls = m.getReturnType();
    String value = null;
    ...
    if (attr != null) {
      ...
      Class<? extends VAttributeKeyNormalizer> vaknClass = attr
              .attributeKeyNormalizer();
      try {
    ...
    if (!cls.isPrimitive() && !isWrapperType(cls) && cls != String.class) {
      ...
      if (con == null) {
        throw new VXMLBindingException(
                "Attribute Specification is invalid. The following Attribute class is not accepted:"
                + cls.getName());
      }
      VConverter vcon = (VConverter) con.converter().newInstance();
      if (!vcon.isConvertCapable(cls)) {
        throw new VXMLBindingException(
                "Attribute Specification is invalid. The following Attribute class: "
                + ""
                + cls.getName()
                + " could not be converted with the specified converter: "
                + vcon.getClass());
    ...
    if (value == null) {
      throw new VXMLBindingException("Error on Attribute Binding: "
              + cls.getName());
    }
  ...
  private boolean checkAttribute(VElement elem, T o, Method m)
          throws Exception {
    Attribute attr = getAnnotation(m, Attribute.class);
    if (attr != null) {
  ...
  private boolean checkId(VElement elem, T o, Method m) throws Exception {
    ...
    if (id != null) {
      ...
      if (g != null) {
        ...
        String sName = "set" + property.toUpperCase().charAt(0)
                + property.substring(1);
        Method setter = o.getClass().getMethod(sName,
  ...
  private void marshallProperties(VElement elem, T o, VNamespace namespace[],
          VMarkupGenerator<T> generator) throws VXMLBindingException {
    ...
    try {
      ...
      Condition classCondition = (Condition) clazz
              .getAnnotation(Condition.class);
      // if this element has no properties, set its content with the
      // toString
      ...
      // check to see if these properties have been specified as
      // attributes
      ...
      for (Method f : getterMethods) {
         ...
         */
        if (!checkId(elem, o, f)) {
          if (aa != null && !ignored.contains(returnType)
            ...
            marshallProperty(elem, o, namespace, generator, mName,
                    f, classCondition);
          }
        }
      }
  ...
  private boolean checkCondition(Method m, Condition classCondition, T o1)
          throws Exception {
    if (classCondition != null) {
      Class condClass = classCondition.condition();
      VConditional<T> vCond = (VConditional<T>) condClass.getConstructor(
    ...
    if (init != null) {
      ...
      if (initAttr == null) {
        ...
        if (index >= inits.length) {
          inits = ArrayUtil.copyOf(inits, inits.length + 1);
          inits[inits.length - 1] = System.identityHashCode(o1) + "";
        } else {
          // we find the right index
          String[] lower = ArrayUtil.copyOfRange(inits, 0, index);
          String[] upper = ArrayUtil.copyOfRange(inits, index,
                  inits.length);
          if (lower.length == 0) {
  ...
  private void marshallProperty(VElement elem, T o, VNamespace namespace[],
          VMarkupGenerator<T> generator, String mName, Method m,
          Condition classCondition) throws VXMLBindingException {
    try {
      m.setAccessible(true);
      // is this method iterable
      com.anosym.vjax.annotations.Iterable it = m
              .getAnnotation(com.anosym.vjax.annotations.Iterable.class);
      T o1 = null;
      do {
        try {
        ...
        if (o1 != null) {
          ...
          // do we have specific attributes to be added to this
          // element
          DefinedAttribute da = m
                  .getAnnotation(DefinedAttribute.class);
          if (da != null) {
            // we do not use the VMarshaller.addAttribute since this
            // is not a generated attribute by the system.
          ...
          addAttribute(fe, new VAttribute(
                  VMarshallerConstants.CLASS_ATTRIBUTE, o1.getClass()
                  .getName()));
          // if the method has been marked with constructible, then we
          // generate a document include
          // for the class schema
          Constructible _const_ = m
                  .getAnnotation(Constructible.class);
          if (_const_ != null) {
            VDocument doc = new VClassMarshaller().marshallClass(m
                    .getReturnType());
            includes.add(doc);
          }
          // if a markup generator is defined ensure that it has not
          // been rescinded in any of the
          // method properties
          Rescind rescind = m.getAnnotation(Rescind.class);
          if (rescind == null) {
            // ok check if the method property defines its on
            // generator
            // this generator does extend to the definition of the
            // object method properties
            DynamicMarkup dynMarkp = m
                    .getAnnotation(DynamicMarkup.class);
            if (dynMarkp != null) {
              Class genClass = dynMarkp.markupGenerator();
              // is it ann inner class
              if (isInner(genClass)) {
                generator = (VMarkupGenerator) newInstance(
                        null, genClass, o);
              } else {
                generator = (VMarkupGenerator) newInstance(
                        null, genClass);
          ...
          // does it have informational attribute, then we set it as
          // informational before the first parent
          Informational info = m.getAnnotation(Informational.class);
          if (info != null) {
            addAttribute(fe, new VAttribute(
                    VMarshallerConstants.INFORMATIONAL_ATTRIBUTE,
                    "true"));
            // be sure that the current element is the top level
            // element
            // otherwise throw an exception
            if (elem.getParent() != null) {
              throw new VXMLBindingException(
                      "Invalid Information field attribute. Information Field must be in the main instance.");
            }
          ...
          if (_ns != null) {
            ...
            namespace = new VNamespace[]{new VNamespace(
              _ns.prefix(), _ns.uri())};
            for (VNamespace namespace1 : namespace) {
           ...
           */
          CollectionElement colElement = m
                  .getAnnotation(CollectionElement.class);
            ...
            if (empty != null && ((Collection) o1).isEmpty()) {
              if (empty.marshall()) {
                if (empty.marshallType()) {
                  ...
                  Class<?> c1 = cls.length > 0 ? cls[0]
                          : null;
                  Class<?> c2 = cls.length > 1 ? cls[1]
                          : null;
                  doMarshall(fe, (T) o1, namespace,
                          elementParam1, elementParam2, c1,
                          c2, true, wrapCollectionElements,
                          m.getAnnotations());
                } else {
                  doMarshall(fe, (T) o1, namespace,
                          elementParam1, elementParam2, null,
                          null, false, false,
                          m.getAnnotations());
                }
              } else if (elem != null) {
              ...
              doMarshall(fe, (T) o1, namespace, elementParam1,
                      elementParam2, null, null, false, false,
                      m.getAnnotations());
            }
            ...
            if (empty != null && ((Map) o1).isEmpty()) {
              if (empty.marshall()) {
                if (empty.marshallType()) {
                  ...
                  doMarshall(fe, (T) o1, namespace,
                          elementParam1, elementParam2, c1,
                          c2, true, false, m.getAnnotations());
                } else {
                  doMarshall(fe, (T) o1, namespace,
                          elementParam1, elementParam2, null,
                          null, false, false,
          ...
          if (r != null && !r.relaxed()) {
            throw new VXMLBindingException(
                    "The following property(" + mName
                    + ") is mandatory");
          }
          // get null handling procedure
          WhenNull whenNull = m.getAnnotation(WhenNull.class);
          if (whenNull == null
                  || whenNull.mode() == WhenNull.NullMode.IGNORE) {
            return;
          }
          marshallNullProperty(elem, namespace, mName, m,
                  whenNull.mode());
        }
  ...
  private void marshallNullProperty(VElement elem, VNamespace namespace[],
          String mName, Method m, WhenNull.NullMode mode)
          throws VXMLBindingException {
    // otherwise lets marshall to empty elements
    Class<?> returnType = m.getReturnType();
    VElement fe = new VElement(mName);
    // add the class attribute
    addAttribute(fe, new VAttribute(VMarshallerConstants.CLASS_ATTRIBUTE,
            returnType.getName()));
    // this is a null property, set the indicator for the unmarshalling
    // procedure
    addAttribute(fe, new VAttribute(VMarshallerConstants.NULL_PROPERTY,
            "true"));
    // if the method has been marked with constructible, then we generate a
    // document include
    // for the class schema
    ...
    // since this value is null, we do not check on dynamic markup
    // generators
    // since this is a null value, we expect it simply not to be a an
    ...
    // even if the generator is specified, we cannot use the dynamic
  ...
  private void marshallNullProperties(VElement elem, VNamespace namespace[],
          Class<?> clazz, WhenNull.NullMode mode) throws VXMLBindingException {
    // do we suppress super class properties
    SuppressSuperClass sp = clazz.getAnnotation(SuppressSuperClass.class);
    Method[] methods = (sp == null) ? clazz.getMethods() : clazz
            .getDeclaredMethods();
    List<Method> getterMethods = new ArrayList<Method>(
            Arrays.asList(methods));
    normalizeMethods(getterMethods, false, clazz);
    ...
    for (Method f : getterMethods) {
      ...
      int i1 = -1, i2 = -1;
      if (name != null
              && ((i1 = name.indexOf("get")) == 0 || (i2 = name
              .indexOf("is")) == 0) && name.length() > 3
        ...
        mName = (mName.charAt(0) + "").toLowerCase()
                + mName.substring(1);
  ...
  public static <T> String toXmlString(T t) {
    try {
      ...
      Logger.getLogger(VMarshaller.class.getName()).log(Level.SEVERE,
              null, ex);
    }
    return null;
  }
