...
public class VDocument {
    ...
    static {
        ...
        //do not use is empty, String.isEmpty() is not supported in kvm
        if (jvm != null && jvm.trim().length() > 0 && jvm.equalsIgnoreCase("Dalvik Core Library")) {
    ...
    public String toString() {
        ...
        return (this.notationDeclaration == null) ? "" : this.notationDeclaration.elemString() + this.rootElement.
                elemString().trim();
    }
    ...
    /**
     * This parsing is adapted for android. Please set system property. 'com.anosym.xml.sax.parser.adapted' to true.
     *
     * @param inn
     * @param handler
     * @throws SAXException
    ...
    /**
     * if this document is an html, it may not be well formed, and therefore, it needs to be cleaned first.
     *
     * @param inn
     * @param isHtml
     * @return
    ...
    public boolean equals(Object obj) {
        ...
        if (this.rootElement != other.rootElement && (this.rootElement == null || !this.rootElement.equals(
                other.rootElement))) {
            return false;
        }
        if (this.documentUrl != other.documentUrl && (this.documentUrl == null || !this.documentUrl.equals(
                other.documentUrl))) {
            return false;
        }
        if (this.documentName != other.documentName && (this.documentName == null || !this.documentName.equals(
                other.documentName))) {
            return false;
        }
        ...
        if (this.notationDeclaration != other.notationDeclaration && (this.notationDeclaration == null || !this.notationDeclaration.
                equals(other.notationDeclaration))) {
            return false;
        }
