    ...
    public String encodeUrl(final T object) throws HttpUrlEncodingException {
      ...
      //get members
            ...
            List<Field> members = getAllFields(clazz, -1, inheritedParam != null
                                               ...
                                               && inheritedParam.encodeInheritedParam() ? inheritedParam.
                                               encodeInheritedLevel() : 0);
            ...
            if (VJaxUtils.isNullOrEmpty(urlEncoded)) {
                throw new IllegalArgumentException("Url for encoding not specified");
            }
            return !VJaxUtils.isNullOrEmpty(urlParams) ? urlEncoded + "?" + urlParams : urlEncoded;
        } catch (Exception es) {
